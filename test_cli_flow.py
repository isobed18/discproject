...
mint_output = run_command("python cli/disc-cli.py --url http://localhost:8000/v1 mint --audience test-service --scope read:data")
print(mint_output)
...
verify_output = run_command(f'python cli/disc-cli.py --url http://localhost:8000/v1 verify "{coupon}"')
print(verify_output)
